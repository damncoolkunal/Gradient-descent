...
ap.add_argument("-a", "--alpha", type =float, default =0.01, help ="learning parameter")
...
print("INFO is training....")
W = np.random.randn(X.shape[1], 1)
losses = []

#loop on the desired no of epochs
...
print("INFO is evaluating")
preds =predict(testX, W)
print(classification_report(testY, preds))


#PLOTTING THE CLASSIFICATION DATA
